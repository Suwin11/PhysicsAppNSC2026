***ในเวอร์ชั่นนี้เป็น .exe ทำให้โหลดมาแล้วรันได้เลย 
windows อาจเตือนว่า game.exe เป็นไฟล์อันตราย ให้กด More info แล้ว Run anyways ได้เลย***

Readme ด้านล่างเป็นของเวอร์ชั้นpython ก่อน pack
